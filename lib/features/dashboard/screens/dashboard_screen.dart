...
class DashboardScreen extends GetView<DashboardController> {
  ...
  Widget build(BuildContext context) {
    ...
    final navigationBarHeight = MediaQuery.of(context).size.height * 0.08;
          ...
          destinations: [
            NavigationDestination(
              icon: controller.currentTab.value == 0
                  ...
                  : Icon(Icons.home_outlined, size: appSize.xl),
              label: 'Home',
            ),
            NavigationDestination(
              icon: controller.currentTab.value == 1
                  ...
                  : Icon(Icons.grid_view_outlined, size: appSize.xl),
              label: 'Collection',
            ),
            NavigationDestination(
              icon: Badge(
                ...
                child: controller.currentTab.value == 2
                    ...
                    : Icon(Icons.shopping_bag_outlined, size: appSize.xl),
              ),
              label: 'Cart',
            ),
            ...
            NavigationDestination(
              icon: controller.currentTab.value == 3
                  ...
                  : Icon(Icons.favorite_border_outlined, size: appSize.xl),
              label: 'Saved',
            ),
            NavigationDestination(
              icon: controller.currentTab.value == 4
                  ...
                  : Icon(Icons.person_outlined, size: appSize.xl),
              label: 'Profile',
            ),
          ],
        ),
