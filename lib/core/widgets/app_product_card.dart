...
class AppProductCard extends StatelessWidget {
  ...
  ProdcutWhistleController get prodcutWhistleController =>
      Get.find<ProdcutWhistleController>();
            ...
            Expanded(
              ...
              child: Stack(
                children: [
                  ...
                  // Only show wishlist button if controller is registered
                  // if (Get.isRegistered<ProdcutWhistleController>())
                  //   Positioned(
                  //     top: 8,
                  //     right: 8,
                  //     child: _ProductCardWishlistButton(
                  //       productId: product.id.toString(),
                  //       controller: prodcutWhistleController,
                  //     ),
                  //   ),
                  isSale == true
                      ? Positioned(
